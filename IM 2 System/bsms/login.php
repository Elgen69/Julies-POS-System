...
<head>
    ...
    <style>
        ...
        @keyframes glowing {
            0% {
                text-shadow: 0 0 10px #4F4A45, 0 0 20px #4F4A45, 0 0 30px #4F4A45, 0 0 40px #4F4A45, 0 0 50px #4F4A45, 0 0 60px #4F4A45, 0 0 70px #4F4A45, 0 0 80px #4F4A45;
            }
            50% {
                text-shadow: 0 0 20px #4F4A45, 0 0 30px #4F4A45, 0 0 40px #4F4A45, 0 0 50px #4F4A45, 0 0 60px #4F4A45, 0 0 70px #4F4A45, 0 0 80px #4F4A45, 0 0 90px #4F4A45;
            }
            100% {
                text-shadow: 0 0 10px #4F4A45, 0 0 20px #4F4A45, 0 0 30px #4F4A45, 0 0 40px #4F4A45, 0 0 50px #4F4A45, 0 0 60px #4F4A45, 0 0 70px #4F4A45, 0 0 80px #4F4A45;
            }
